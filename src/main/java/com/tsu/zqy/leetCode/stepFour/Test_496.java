...
public class Test_496 {
    ...
    public int[] nextGreaterElement(int[] nums1, int[] nums2) {
            ...
            if (stack.isEmpty()) {
                ...
                if (i > topNum) {
                    while (!stack.empty()) {
                        ...
                        nextGreaterResult.put(stack.pop(), i);
                    }
                }
                stack.push(i);
            }
        ...
        for (int i = 0; i < nums1.length; i++) {
            result[i] = nextGreaterResult.getOrDefault(nums1[i], -1);
        }
        return result;
    }
}
